...
public class TablaVertical extends Tabla {
	...
	public TablaVertical(boolean paraGrande) {
		if (paraGrande)
			sprite = new Sprite(new Texture("tablabig.png"));
		else
			sprite = new Sprite(new Texture("tablaGira.png"));
	}
	...
	public FixtureDef fixtureDef() {
		...
		polygonShape.setAsBox((sprite.getWidth() / 2) * Constants.PIXELS_TO_METERS,
